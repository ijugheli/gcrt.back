                    ...
                    <tbody>
                        ...
                        <tr>
                            <td width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <table class="m_-4398825389557393514inner-body" align="center" width="570"
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <p
                                                    ...
                                                    ავტორიზაციის გასავლელად გთხოვთ გამოიყენოთ მოცემული კოდი
                                                </p>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td
                                                                                                style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                                                                                <span
                                                                                                    class="m_-4398825389557393514button"
                                                                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';border-radius:4px;color:#fff;display:inline-block;overflow:hidden;text-decoration:none;background-color:#2d3748;border-bottom:8px solid #2d3748;border-left:18px solid #2d3748;border-right:18px solid #2d3748;border-top:8px solid #2d3748; font-weight: bold; font-size: 20px;">
                                                                                                    {{ $code}}</span>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                ...
                                                <p
                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                                    გაითვალისწინეთ, რომ ეს კოდი ვალიდურია მომდევნო 5 წუთის
                                                    განმავლობაში.</p>
                                                <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                        ...
                        <tr>
                            <td
                                style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                <table class="m_-4398825389557393514footer" align="center" width="570" cellpadding="0"
                                    cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <p
                                                    ...
                                                    © 2023 <a href="http://gcrt.ge" target="_blank">GCRT.GE</a>
